    ...
    <section className="relative pt-8 pb-18 md:pt-12 md:pb-24 xl:pt-18 xl:pb-30">
      <div className="section-shell grid items-center gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:gap-12 xl:gap-16">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-[0.72rem] font-semibold uppercase tracking-[0.22em] text-primary">
            <Snowflake className="size-3.5" />
            Premium Aircon Services in Cavite
          </div>
          <h1 className="mt-5 max-w-4xl text-[clamp(3rem,5.8vw,5.65rem)] font-semibold leading-[0.97] text-white">
        ...
        <div className="glass-panel blue-glow relative overflow-hidden rounded-[2rem] p-4 md:p-5 xl:p-6">
          ...
          <div className="absolute top-8 right-8 rounded-2xl border border-white/10 bg-[#081227]/88 p-4 backdrop-blur-xl">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-primary/15">
                <Timer className="size-5 text-primary" />
              </div>
              <div>
                <p className="text-sm text-[#9fb0d1]">Response time</p>
                <p className="font-semibold text-white">Same-day in most areas</p>
              </div>
            </div>
          </div>
          <div className="absolute bottom-8 left-8 rounded-2xl border border-white/10 bg-[#081227]/88 p-4 backdrop-blur-xl">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-secondary/15">
                <Shield className="size-5 text-secondary" />
              </div>
              <div>
                <p className="text-sm text-[#9fb0d1]">Trusted workmanship</p>
                <p className="font-semibold text-white">Diagnostic-first service</p>
              </div>
            </div>
          </div>
        </div>
