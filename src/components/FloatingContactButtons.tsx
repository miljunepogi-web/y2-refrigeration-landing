...
export function FloatingContactButtons() {
  return (
    <div className="fixed right-3 bottom-3 z-50 flex flex-col items-center gap-2 rounded-[1.2rem] border border-white/10 bg-[#081227]/78 p-2 shadow-[0_18px_40px_rgba(3,9,26,0.32)] backdrop-blur-xl sm:right-4 sm:bottom-4 sm:rounded-[1.4rem] sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none sm:backdrop-blur-0">
      <Link
